...
echo cheevos_enable = "true">> C:\RetroCake\RetroArch\retroarch.cfg
echo cheevos_test_unofficial = "false">> C:\RetroCake\RetroArch\retroarch.cfg
echo cheevos_hardcore_mode_enable = "true">> C:\RetroCake\RetroArch\retroarch.cfg
...
echo cheevos_username = "flerp">> C:\RetroCake\RetroArch\retroarch.cfg
echo cheevos_password = "lol123">> C:\RetroCake\RetroArch\retroarch.cfg
