...
%rkdir%\Tools\Wget\wget.exe -q http://buildbot.libretro.com/nightly/windows/x86_64/latest/mupen64plus_next_libretro.dll.zip -O "%rkdir%\Temp\cores\68.zip"
...
%rkdir%\Tools\Wget\wget.exe -q http://buildbot.libretro.com/nightly/windows/x86/latest/mupen64plus_next_libretro.dll.zip -O "%rkdir%\Temp\cores\68.zip"
