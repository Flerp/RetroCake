...
echo =                                                                         =
echo =    2.) FULL SETUP WITH DEFAULT ROM DIRECTORIES (C:\ROMS\SYSTEMNAME)     =
echo =                                                                         =
...
echo ===========================================================================
echo =                                                                         =
Echo =    1.) CREATE DEFAULT ROM DIRECTORIES (C:\ROMS\SYSTEMNAME)              =
echo =                                                                         =
...
echo =================================================================
mkdir C:\RetroArch
powershell -command "Invoke-WebRequest -Uri https://buildbot.libretro.com/nightly/windows/x86_64/RetroArch.7z -OutFile "%USERPROFILE%\RetroArch_x64.zip""
...
echo =================================================================
mkdir C:\RetroArch
powershell -command "Invoke-WebRequest -Uri https://buildbot.libretro.com/nightly/windows/x86/RetroArch.7z -OutFile "%USERPROFILE%\RetroArch_x86.zip""
